...
var patchCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		newVersion := semver.BumpPatch(oldVersion)
...
func init() {
	...
	patchCmd.Flags().BoolP("tag", "t", false, "Create a git tag")
	patchCmd.Flags().BoolP("push", "p", false, "Push the git tag to remote origin")
}
